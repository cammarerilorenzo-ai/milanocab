...
export function RideBookingForm() {
  ...
  return <form onSubmit={handleSubmit} className="space-y-6">
      ...
      <div className="space-y-2">
        ...
        })} className="inline-flex items-center gap-1.5 px-3 py-1.5 text-xs font-medium bg-yellow-400 hover:bg-yellow-500 text-blue-600 rounded-full border border-yellow-500 transition-colors">
